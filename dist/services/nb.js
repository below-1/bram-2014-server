...
function nb(data, x) {
    const _nbSumm = exports.nbSummary();
    const _summary = summary_1.summary(data);
    const xkategori = drow_1.kategori(x);
